...
4. The relevant file under `docs/etf_tricks/prompts/etfs/` — one ETF's unique contract.
5. `docs/superpowers/plans/2026-08-26-etf-tricks-implementation.md` — task ordering and file-level implementation plan.
6. Later implementation notes that do not amend an authority above.
