...
Goal ID: `GOAL-ETF-TRICKS-001`. Downstream AFML authority lives in `docs/afml/prompts/`.
...
The upstream Goal ends at validated Daily NAV, Daily ETF amount, allocation, and readiness. `docs/afml/prompts/` consumes those immutable outputs but may not amend upstream selection or accounting semantics.
...
- Transfer to `docs/afml/prompts/README.md` before any Dollar-bar, FFD, feature, label, or strategy work; its artifact-readiness gates remain binding.
